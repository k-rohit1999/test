...
const SuccessComponent = (...props) => {
    ...
    return (
        <div className="d-flex flex-column align-items-center justify-content-center" style={{marginTop:'20%', marginBottom:'20%'}}>
            ...
            <div className="d-flex flex-column align-items-center col-auto col-md-8 mb-4" style={{fontSize:'18px', fontWeight:'600'}}>
                Your Appointment for {item.serviceName} at 
                <p className="mb-0">{item.bpName} is booked for {dt}</p>
                <p className="mt-2">at {item.time}</p>
            </div>
            <div className="col-auto col-md-8 d-flex flex-column align-items-center" style={{fontSize:'15px'}}>
                Please reach the store 15 mins before the
